...
#elif defined(CONFIG_S5PC110_S1_TELUS_BOARD) // NAGSM_HQ_CAMERA_LEESUNGKOO_20110418 : EXIF model name.
	unsigned char ce147_str_model[10] = "SGH-T959D\0";
#elif defined(CONFIG_S5PC110_S1_BMC_BOARD)
	unsigned char ce147_str_model[10] = "GT-I9000M\0";
#elif defined(CONFIG_S5PC110_KEPLER_ROGERS_BOARD)
	unsigned char ce147_str_model[9] = "SGH-i896\0";
#else //aries_eur
