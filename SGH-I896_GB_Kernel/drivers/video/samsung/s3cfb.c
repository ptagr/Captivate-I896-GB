...
#if defined(CONFIG_S5PC110_S1_BMC_BOARD)
#include "logo_rgb24_wvga_portrait_I9000M.h"
#elif defined(CONFIG_S5PC110_S1_TELUS_BOARD)
#include "logo_rgb24_wvga_portrait_T959D.h"
