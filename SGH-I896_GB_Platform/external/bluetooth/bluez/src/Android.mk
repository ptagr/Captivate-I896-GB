...
ifeq ($(TARGET_PRODUCT),SGH-I896)
LOCAL_CFLAGS += -DSWP1_BLUETOOTH_ARIES
LOCAL_CFLAGS += -DNAGSM_BLUETOOTH_KEPLERROGERS
endif

ifeq ($(TARGET_PRODUCT),GT-I9000M)
LOCAL_CFLAGS += -DSWP1_BLUETOOTH_ARIES
LOCAL_CFLAGS += -DNAGSM_BLUETOOTH_KEPLERBMC
endif

ifeq ($(TARGET_PRODUCT),SGH-T959D)
LOCAL_CFLAGS += -DSWP1_BLUETOOTH_ARIES
LOCAL_CFLAGS += -DNAGSM_BLUETOOTH_KEPLERTELUS
endif
